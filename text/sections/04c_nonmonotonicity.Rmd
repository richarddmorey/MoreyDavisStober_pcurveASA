...
This behaviour is especially strange considering the intention of the compound procedure: to help make the procedure robust to "$p$ hacking". As Simonsohn et al. (2015) make clear, $p$ hacking to smaller $p$ values is more difficult; a nonmonotone procedure, then, penalizes a set for containing a value that is *less* consistent with $p$ hacking when it crosses the half $P$-curve boundary.
